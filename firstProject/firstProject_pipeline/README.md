# firstProject_pipeline

This folder defines all source code for the 'firstProject_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_firstproject_pipeline.py" to get familiar with the syntax.
